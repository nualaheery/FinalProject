...
public class RepayCreditDialog extends AppCompatDialogFragment {

    private EditText amountChosenToRepay;
    private double totalCreditAmount =  GamePlayActivity.player.getCreditAmount();
    private double totalDebitAmount = GamePlayActivity.player.getDebitAmount();
        ...
        if (d != null) {
            ...
            positiveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (amountEntered > (totalCreditAmount *-1) ){ //make credit amount positive for comparison
                    ...
                    } else if (amountEntered > totalDebitAmount) {
                        ...
                        GamePlayActivity.player.setDebitAmount(totalDebitAmount - amountEntered);
